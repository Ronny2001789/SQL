...
SELECT make_timestamptz(year, month, day, hour, minute, second, time zone)
...
FROM 'C:\Users\Ronny mputla\OneDrive\Desktop\code-college 2\SQL\SQL\my_code\Chapter_11\yellow_tripdata_2016_06_01.csv'
...
SELECT
    date_part('hour', tpep_pickup_datetime) AS local_hour,
    COUNT(*) AS trip_count
